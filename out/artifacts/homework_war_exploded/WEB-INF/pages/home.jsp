    ...
    <div class="am-container header">
        ...
        <ul class="message-r">
            ...
            <div class="topMessage mini-cart">
                <div class="menu-hd"><a id="mc-menu-hd" href="/user/getCart" target="_top"><i class="am-icon-shopping-cart  am-icon-fw"></i><span>购物车</span><strong id="J_MiniCartNum" class="h">${cart.totalnum}</strong></a></div>
            </div>
            ...
            <div class="am-g am-g-fixed sale">
                <c:forEach items="${list}" var="item">
                    <div class="am-u-sm-3 sale-item">
                        <div class="s-img">
                            <a href="# "><img src=${item.pimg} /></a>
                        </div>
                        <div class="s-info">
                            <a href="#"><p class="s-title">${item.pname}</p></a>
                            <div class="s-price">￥<b>${item.price}</b>
                                <a class="s-buy" href="${pageContext.request.contextPath}/cart/addCart?goodId=${item.pid}">加入购物车</a>
                            </div>
                        </div>
                    </div>
                </c:forEach>
